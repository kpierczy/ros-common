...
# 
# 
# @note This file does only contain a selection of the most common options. For a full list see the documentation [1]
# @see [1] http://www.sphinx-doc.org/en/master/config
