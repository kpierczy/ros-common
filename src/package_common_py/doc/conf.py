...
# Add python module to the PATH for autodocumentation
sys.path.insert(0, os.environ['MODULE_HOME'])

# ======================================================= Project information ====================================================== #

# Project info
project = 'launch_common_py'
copyright = 'Krzysztof Pierczyk © 2022'
...
# ===================================================== 'autodoc' configruation ==================================================== #

# Force autodoc to parse __init__ comment
